...
import { MostPopularExercises } from '../ui/PieChart';
import Link from 'next/link';
import { ProcessWorkoutData } from '../ui/ProcessWorkoutData';
import WeightVsTime from '../ui/WeightVsTime';
    ...
    <div className='mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 p-4'>
      ...
      <div className='flex flex-row flex-wrap items-center justify-center gap-8'>
        <div className='flex justify-center'>
          <MostPopularExercises history={workout_history} />
        </div>
        <div className='1 flex justify-center'>
          <ProcessWorkoutData history={workout_history} />
        </div>
        <div className='1 flex justify-center'>
          <WeightVsTime history={workout_history}/>
        </div>
      </div>
